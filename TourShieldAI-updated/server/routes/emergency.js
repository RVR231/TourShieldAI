...
async function sendEmergencyNotifications(alert, isTest = false) {
  ...
  const subject = `${alertType} - TourShield Emergency System`;
  
  const message = isTest 
    ? `This is a test of the TourShield emergency alert system. If this was a real emergency, you would receive location and contact information.`
    : `EMERGENCY ALERT from TourShield user!
