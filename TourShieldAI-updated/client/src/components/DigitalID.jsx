...
const DigitalID = () => {
  ...
  const downloadID = () => {
    ...
    a.href = url;
    a.download = `TourShield-DigitalID-${digitalID.id}.json`;
    a.click();
  ...
  const generateRealQRCode = async (qrData) => {
    try {
      ...
      const qrContent = JSON.stringify({
        ...
        hash: qrData.hash,
        network: qrData.network || 'TourShield Blockchain',
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <div className="text-center">
              ...
              <div className="mt-4 text-sm text-gray-600">
                <p><strong>Note:</strong> After KYC approval, your blockchain Digital ID will be automatically generated and secured on the TourShield blockchain network.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          <div className="bg-gradient-to-r from-indigo-500 to-purple-600 p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-xl font-bold">TourShield Digital ID</h2>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{userData?.role || 'TourShield Member'}</p>
                  </div>
                </div>
