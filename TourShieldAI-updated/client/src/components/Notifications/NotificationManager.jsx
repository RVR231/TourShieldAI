...
// Predefined notification types for TourShield AI
export const TourShieldNotifications = {
  // Authentication notifications
  auth: {
    loginSuccess: () => NotificationManager.success(
      'Welcome back!', 
      'You have successfully logged in to TourShield AI.'
    ),
  ...
  scanner: {
    ...
    invalidCode: () => NotificationManager.warning(
      'Invalid QR Code', 
      'This QR code is not recognized by TourShield AI.'
    )
  }
};
