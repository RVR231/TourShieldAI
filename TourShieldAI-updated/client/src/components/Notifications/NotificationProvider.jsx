...
import NotificationManager, { TourShieldNotifications } from './NotificationManager';
...
export const NotificationProvider = ({ children }) => {
  ...
  // TourShield AI specific notifications
  const safeTourNotify = TourShieldNotifications;
