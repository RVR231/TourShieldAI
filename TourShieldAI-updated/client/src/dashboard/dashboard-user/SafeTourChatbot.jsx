...
const TourShieldChatbot = ({ activeTab, setActiveTab }) => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      type: 'bot',
      content: '🧭 Welcome to TourShield AI Chatbot! I\'m here to help you stay safe while traveling. You can ask me about travel safety, emergencies, cultural tips, and much more. How can I assist you today?',
      timestamp: new Date()
    }
  ]);
      ...
      <div className="bg-white rounded-lg shadow-2xl border border-gray-200 h-full flex flex-col">
        ...
        <div className="flex items-center justify-between p-4 bg-gradient-to-r from-blue-600 to-teal-500 text-white rounded-t-lg">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="font-semibold text-sm">TourShield AI Chatbot</h3>
...
export default TourShieldChatbot;
